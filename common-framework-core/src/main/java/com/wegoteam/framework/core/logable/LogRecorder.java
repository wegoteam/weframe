...
import com.wegoteam.framework.core.exception.AppException;
import com.wegoteam.framework.util.StringUtils;
...
public class LogRecorder {
    ...
    @Around("@annotation(com.wegoteam.framework.core.logable.Logable)")
