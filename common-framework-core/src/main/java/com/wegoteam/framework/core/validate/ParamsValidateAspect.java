...
import com.wegoteam.framework.core.exception.ParamException;
...
public class ParamsValidateAspect {
     ...
     */
    @Pointcut("@annotation(com.wegoteam.framework.core.validate.ParamsValidate)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 查找带有参数校验的注解
        ParamsValidate paramsValidate = targetMethod.getAnnotation(ParamsValidate.class);
